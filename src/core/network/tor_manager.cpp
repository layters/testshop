...
TorManager::TorManager(uint16_t socks_port) {
...
void TorManager::start_tor() {
    ...
    is_running = true; // TODO: Find a more accurate way to check if tor is running by checking if port 9052 is taken
    ...
    poll_hostname(); // Still blocks for onion
}
