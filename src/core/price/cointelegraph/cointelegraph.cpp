...
const std::map<neroshop::Currency, std::string> CURRENCY_TO_ID{
    ...
    {neroshop::Currency::HKD, "HKD"},
    {neroshop::Currency::INR, "INR"},
    {neroshop::Currency::JPY, "JPY"},
    {neroshop::Currency::KRW, "KRW"},
    {neroshop::Currency::MXN, "MXN"},
    {neroshop::Currency::NZD, "NZD"},
    {neroshop::Currency::PHP, "PHP"},
    {neroshop::Currency::RUB, "RUB"},
    {neroshop::Currency::SEK, "SEK"},
    {neroshop::Currency::SGD, "SGD"},
    {neroshop::Currency::ZAR, "ZAR"},
    {neroshop::Currency::NGN, "NGN"},
    {neroshop::Currency::GHS, "GHS"},
